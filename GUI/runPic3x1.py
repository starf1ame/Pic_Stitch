...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        Dialog.resize(600, 1000)
        self.initUI()

        '''
        Label for the up side picture
        '''
        ...
        self.label_2.setGeometry(QtCore.QRect(30, 335, 210, 190))
        self.label_2.setObjectName("label_2")

        '''
        Label for the down side picture
        '''
        self.label_3 = QtWidgets.QLabel(Dialog)
        self.label_3.setGeometry(QtCore.QRect(30, 580, 210, 190))
        self.label_3.setObjectName("label_3")

        '''
        Button for choosing the up side picture file
        '''
        self.pushButton = QtWidgets.QPushButton(Dialog)
        self.pushButton.setGeometry(QtCore.QRect(77, 290, 115, 35))
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(77, 535, 115, 35))
        self.pushButton_2.setObjectName("pushButton_2")
        self.pushButton_2.clicked.connect(self.medium_pic)
        self.pushButton_2.setStyleSheet(self.button_style)

        '''
        Button for choosing the down side picture file
        '''
        self.pushButton_3 = QtWidgets.QPushButton(Dialog)
        self.pushButton_3.setGeometry(QtCore.QRect(77, 780, 115, 35))
        ...
        self.label_4.setGeometry(QtCore.QRect(270, 125, 270, 645))
        ...
        self.chooseAlg.setGeometry(QtCore.QRect(270, 90, 250, 30))
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(270, 780, 115, 35))
        ...
        self.pushButton_5.setGeometry(QtCore.QRect(425, 780, 115, 35))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton.setText(_translate("Dialog", "choose up"))
        self.pushButton_2.setText(_translate("Dialog", "choose medium"))
        self.pushButton_3.setText(_translate("Dialog", "choose down"))
